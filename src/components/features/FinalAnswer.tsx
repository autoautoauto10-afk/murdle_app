...
export default function FinalAnswer({ suspects, weapons, locations, onCheck }: FinalAnswerProps) {
    ...
    return (
        <div className="bg-stone-800 text-stone-100 p-8 rounded-xl shadow-2xl">
            <h2 className="text-2xl font-serif font-bold mb-6 text-center text-amber-400">最終回答</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div>
                    <label className="block text-sm font-bold mb-2 uppercase tracking-wider text-stone-400">容疑者</label>
                    <select
                        value={s}
                ...
                <div>
                    <label className="block text-sm font-bold mb-2 uppercase tracking-wider text-stone-400">凶器</label>
                    <select
                        value={w}
                ...
                <div>
                    <label className="block text-sm font-bold mb-2 uppercase tracking-wider text-stone-400">場所</label>
                    <select
                        value={l}
